...
echo "<from class='form-horizontal' action='read_message.php' method='post'>";
echo "<input type='hidden' name='receiver_id' value='".$receiver_id."'>";
echo "<div class='form-group'>";
echo "<label class='col-sm-2 control-label'>TO</label>";
echo "<div class='col-sm-10'>";
echo "<p class='form-control-static' name='receiver' value=".$receiver.">".$receiver."</p>";
echo "</div>";
echo "</div>";
echo "<div class='form-group'>";
...
echo "<div class='col-sm-10'>";
echo "<textarea name='title' placeholder='Say something' class='form-control' rows='6'></textarea>";
echo "</div>";
echo "</div>";
echo "<div class='form-group'>";
